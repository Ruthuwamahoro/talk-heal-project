...
export const WhyEmoHubSection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-rose-50/50 via-amber-50/30 to-emerald-50/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="group relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border border-white/50 hover:border-rose-200/50"
            >
              {/* Gradient Background */}
              ...
              {/* Content */}
              <h3 className="relative text-xl font-bold text-slate-900 mb-4 group-hover:text-rose-600 transition-colors duration-300">
                {benefit.title}
              </h3>
